...
function measure(shape:Point[],linear:Vector3,omega:Vector3,height=0,rotation=new Quaternion()){
  ...
  const result=applyWheelFluid(body,shape,0,{x:0,y:-1,z:0},'water',()=>({height:0,vx:0,vy:0,vz:0,wet:true}),1/90);
