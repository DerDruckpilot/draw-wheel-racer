...
- Größenlimit, sichtbare Achsmarkierung, vier Formvorlagen, Rückgängig und lokal gespeicherte Lieblingsform.
...
Sechs Auftriebspunkte approximieren das verdrängte Chassisvolumen. Untergetauchte Radabschnitte erfahren normalen Druckwiderstand und kleineren tangentialen Widerstand; daraus entsteht die Paddelwirkung. Die visuelle Wasseroberfläche nutzt animierte Wellen und Glanz. Es gibt keine vollständige Flüssigkeits- oder Wellensimulation.
...
- `npm test`: Eingabegrenzen, Vortrieb über Kontakt, Eis-Traktion, Energieverhalten ohne Antrieb, offene Formen, wiederholte Radwechsel, Auftrieb/Paddelantrieb und Instanziierung aller Strecken.
- `npm run test:courses`: vollständige Fahrten aller zwölf Rennen und des Testgeländes mit einer einfachen Wechselstrategie zwischen runden Rädern und Paddeln. Erwartet Zielankunft; protokolliert Zeit, Lage und Bergungen.
...
Alle 13 Strecken wurden mit echten Simulationsschritten bis zum Ziel gefahren, ohne Bergungen; die Fahrzeiten lagen zwischen 38,4 und 82,2 Sekunden. Die sechs automatischen Physiktests bestanden.
